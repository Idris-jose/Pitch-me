    ...
    return (
        <section className="min-h-screen flex items-center justify-center bg-[#0f121e] text-white p-5 font-sans" style={{ background: 'radial-gradient(circle at bottom left, rgba(74, 53, 115, 0.4), transparent 50%), radial-gradient(circle at top right, rgba(23, 27, 48, 1), transparent 50%), #0f121e' }}>
            <div className="max-w-[440px] w-full">
                <h1 className="text-[28px] font-bold mb-2 tracking-[-0.5px]">Create your account</h1>
                <p className="text-[14px] text-[#9496a7] mb-8">Start your journey to better communication today.</p>
                ...
                <div className="text-center mt-6 text-[13px] text-[#6c718a]">
                    Already have an account? <a href="#" className="text-[#6366f1] no-underline transition-colors hover:text-[#818cf8]">Log in</a>
                </div>
            </div>
        </section>
    );
